<template>
    <div class="map" :width="svgWidth" :height="svgHeight">
...
export default {
    ...
    computed: {
        ...
        svgWidth: {
            ...
            set (element) {
                this.viewbox.width = this.width || element.offsetWidth
            }
        },
        svgHeight: {
            get () {
            ...
            set (element) {
                this.viewbox.height = this.height || element.offsetHeight
            }
        },
        pathStyle () {
    ...
    methods: {
        ...
        resize () {
            ...
            this.svg.selectAll('g').attr('transform', 'scale(' + (newSize / oldSize) + ')')
        },
        fillColor (d) {
